...
module.exports = {
  data: new SlashCommandBuilder()
    .setName("papagali")
    .setDescription("Qual jogo o papagali ta jogando agora?"),
  async execute(interaction) {
    await interaction.deferReply(); // Defer the reply as API calls can take time

    const steamApiUrl = `https://api.steampowered.com/ISteamUser/GetPlayerSummaries/v0002/?key=${STEAM_API_KEY}&steamids=76561198813854287`;
